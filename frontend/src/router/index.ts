...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/wiki/:id', name: 'wiki-post', component: () => import('@/pages/WikiPostPage.vue') },
    ...
    { path: '/admin/wiki/reports', name: 'admin-wiki-reports', component: () => import('@/pages/AdminWikiReportsPage.vue') },
